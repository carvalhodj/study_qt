...
int main(int argc, char* argv[]) {
    ...
    volumeLCD->setPalette(Qt::magenta);
    ...
    QObject::connect(lengthSlider, SIGNAL(valueChanged(int)), volumeDial,
    SLOT(setValue(int)));
    
    QObject::connect(volumeDial, SIGNAL(valueChanged(int)), lengthSlider,
    SLOT(setValue(int)));
